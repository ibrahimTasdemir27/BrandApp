...
import com.example.markaapp.databinding.DetailBrandLayoutBinding
...
class DetailBrandViewController: AppCompatActivity(), DetailBrandViewModelDelegate {
    ...
    private fun initUI() {
        countryTextView.text = viewModel.brandModel.country
        brandNameTextView.text = viewModel.brandModel.name
        brandDescriptionTextView.text = viewModel.brandModel.description
    }
